...
config :seven_el_bee, SevenElBeeWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "p+18AhUWSTvqq9bCAm27kN3N/LFzFWaSP7VLcb0tQchvXkMx1wlksZYNRWPsdSm+",
  watchers: [
    node: ["build.js", "--watch", cd: Path.expand("../assets", __DIR__)]
  ]

config :seven_el_bee, SevenElBeeWeb.DealerLive, cheating: true
...
config :seven_el_bee, SevenElBeeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/Axis_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :seven_el_bee, dev_routes: true
